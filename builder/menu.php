      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
		  ...
		  <div class="dropdown" style="padding : 0px">
            <li class="nav-item"><a class="nav-link btn  dropdown-toggle dropdown"type="button" style="font-size : 13px ; padding: 24px 20px !important">Details</a></li>
            <ul class="dropdown-menu" style="background-color : #252A2B">
              <li><a class="nav-link" href="aminityshow.php">Aminitys</a></li>
			  <li><a class="nav-link" href="bookingshow.php" class="nav-link">Booking</a></li>
              <li><a class="nav-link" href="imagegallery.php" style="font-color : white">Image Gallery</a></li>
			  <li><a class="nav-link" href="propertyshow.php">My Property</a></li>
			  <li><a class="nav-link" href="propertyimageshow.php">Property Image</a></li>
			  <li><a class="nav-link" href="paymentshow.php">Payment</a></li>
            </ul>
			</div>
		   ...
		   <div class="dropdown" style="padding : 0px">
            ...
            <ul class="dropdown-menu" style="background-color : #252A2B">
              <li><a class="nav-link" href="reviewshow.php" style="font-color : white">Review</a></li>
			   <li><a class="nav-link" href="emailshow.php">Email</a></li>
			  <li><a class="nav-link" href="inquiry.php">Inquiry</a></li>
