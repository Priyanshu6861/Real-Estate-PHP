...
<div class="page-content page-container" id="page-content">
    <div class="padding">
		...
		if($result)
		{
		  $query="select * from buyer p,city c where p.cityid=c.cityid and buyerid='$regid' ";
		  $rw=$dc->getRecord($query);
                           echo("<div class='m-b-25'><img src='userimages/".$rw['image']."' style='width : 50%' class='img-radius' alt='User-Profile-Image'> </div>");                           
                              echo("<h6 class='f-w-600 fa fa-user' class='f-w-600' style='font-size:20px'> ".$rw['buyername']."</h6>"); 
