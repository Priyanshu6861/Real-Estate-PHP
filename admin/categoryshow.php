...
<head>
   ...
   <?php
	 ...
	 if(isset($_POST['btnnew']))
	  ...
	  {
		$_SESSION['trans']="";   
		header('location:categoryreport.php');  
	  }
   ?>
    ...
    <div class="table-responsive">
      <table class="table table-striped b-t b-light">
		...
		while($rw=mysqli_fetch_array($tb))
		{
			...
			echo("<td><button type='submit' class='btn btn-primary' name='btnupdate' value='".$rw['catid']."'>UPDATE</button></td>");
			echo("<td><button type='submit' class='btn btn-danger' name='btndelete' value='".$rw['catid']."'>DELETE</button></td>");
			echo("</tr>");
				$count++;
			}
			echo("<tr>");
